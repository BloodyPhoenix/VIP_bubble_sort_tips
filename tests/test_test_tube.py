...
class TestTube(unittest.TestCase):
    ...
    def test_check_balls_amount(self):
        ...
        self.tube._update_balls_list()
        self.tube.check_balls_amount()
        self.assertEqual(3, self.tube.balls_amount)

    def test_can_put_ball_False(self):
        self.assertEqual(False, self.tube.check_can_put_into())

    def test_if_completed_False(self):
        self.assertEqual(False, self.tube.check_if_completed())
    ...
    def test_put_new_ball(self):
        ...
        self.assertEqual(3, self.tube.balls_amount)
        self.assertEqual(True, self.tube.check_can_put_into())
        self.assertEqual(False, self.tube.check_if_empty())
        self.assertEqual(False, self.tube.check_if_completed())
    ...
    def test_remove_ball(self):
        ...
        self.assertEqual(self.tube.check_if_empty(), False)
